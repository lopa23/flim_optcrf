import sys
sys.path.insert(0,'/home/mukherjl/Downloads/exit/lib/python2.7/site-packages/cvxpy/__init__.pyc')
#from /home/mukherjl/Downloads/exit/lib/python2.7/site-packages/cvxpy/__init__.pyc
import cvxpy as cp
import numpy as np
#p = cvxpy.load_source('module.name', '/home/mukherjl/Downloads/exit/lib/python2.7/site-packages/cvxpy/__init__.pyc')
